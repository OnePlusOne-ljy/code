...
if __name__ == '__main__':
    args = {
        ...
        'MODEL_NAME': '/home/wutianyi/seqmodel/RWKV-LM/RWKV-v5/model/0.1-1/rwkv-init', #模型文件的名字，pth结尾的权重文件。
    ...
    tokenizer = RWKV_TOKENIZER("/home/wutianyi/research/RWKV_Pytorch/asset/rwkv_vocab_v20230424.txt")
    print(model)
    print("Done.")
    ...
    for step in tqdm(range(LENGTH_PER_TRIAL)):  # 生成指定数量的token
