...
if __name__ == '__main__':
    ...
    tokenizer = RWKV_TOKENIZER(r"C:\Users\17506\Desktop\RWKV_Pytorch\asset\rwkv_vocab_v20230424.txt")
    print(model)
    print("Done.")
    
    # 设置续写的初始字符串和参数
    initial_string = "ABCCABBABCCCABBAADCCABCABBCCABBDACDDADCCAACCABDBDDCCABCDABCCDBBABABCABDADBCCABBABCCCAABCADBCABCABBCCAABDADDDABCCACBABCCCDBBAADCBAB\n"
    batch_size = 1
    TEMPERATURE = 1  # 温度参数
    TOP_P = 0  # Top-p采样参数
